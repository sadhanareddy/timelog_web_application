...
?>
  ...
  <div class="container" > <!-- second div  & start of the container-->
    <button id="homebtn" type="button" class="btn btn-primary" style="margin-right:10px" onclick="location.href='index.html'"><span class="glyphicon glyphicon-home"></span>Home</button>
    
    <form class="form-horizontal" role="form" method="post" action="connectreg.php"> <!-- start of the form -->
      <h1 id ="reg_form" class="text-primary" align="center">Registration form</h1><br/><br/>

      <div class="form-group">
        <label class="control-label col-sm-5" for="email">First Name:<span class="glyphicon glyphicon-user"></span></label>
        <div class="col-sm-3">
          <input type="text" class="form-control" id="firstname" name="fname" placeholder="Enter firstname" ><span class="error"><?php echo $fnameErr;?></span>
        </div>
      </div>
...
</div> <!-- end of second div and end of the container-->
</body>
</html>
